...
('Administrateur Système', 'admin@elections.cm', '$2b$10$hash', 'admin', 1, 'BP 1001', 'Yaoundé', '+237 677 123 456', 'SYSTEM', NOW()::VARCHAR, 1),
('Jean MBALLA', 'jean.mballa@elections.cm', '$2b$10$hash', 'jmballa', 3, 'BP 1002', 'Douala', '+237 677 234 567', 'admin', NOW()::VARCHAR, 1),
('Marie NGONO', 'marie.ngono@elections.cm', '$2b$10$hash', 'mngono', 3, 'BP 1003', 'Yaoundé', '+237 677 345 678', 'admin', NOW()::VARCHAR, 1),
('Paul ATANGANA', 'paul.atangana@elections.cm', '$2b$10$hash', 'patangana', 4, 'BP 1004', 'Buea', '+237 677 456 789', 'admin', NOW()::VARCHAR, 1),
('Alice FOUDA', 'alice.fouda@elections.cm', '$2b$10$hash', 'afouda', 4, 'BP 1005', 'Bafoussam', '+237 677 567 890', 'admin', NOW()::VARCHAR, 1);
